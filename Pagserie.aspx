<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Pagserie.aspx.vb" Inherits="urating.Pagserie" %>
               ...
               <div class="card-body">
                  <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <center>
                                <asp:Label  ID="nomeserie" runat="server" Text="Label" ForeColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="Bahnschrift" Font-Overline="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="True"></asp:Label>
                                &nbsp;
                            </center>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:friendflixDBConnectionString %>" SelectCommand="select b.foto,a.* from avaliacao_series a
inner join usuarios b on a.usuario = b.usuario
where nome_serie = @nome_serie
order by likes desc">
                                <SelectParameters>
                                    <asp:SessionParameter Name="nome_serie" SessionField="serie" />
                                </SelectParameters>
                            </asp:SqlDataSource>
