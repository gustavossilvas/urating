...
Public Class Paglivro
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cmd.CommandText = "select * from livros where nome_livro = '" + Session("livro") + "'"
        cmd.ExecuteNonQuery()
        ...
        nomelivro.Text = table.Rows(0)(1).ToString()
        conexao.Close()
    End Sub
    Protected Sub DlistUser_ItemCommand(source As Object, e As DataListCommandEventArgs) Handles DlistUser.ItemCommand
        ...
        If (e.CommandName = "like") Then
            ...
            cmd2.CommandText = "select likes from avaliacao_livros where nome_livro = '" + Session("livro") + "' and usuario = '" + e.CommandArgument.ToString() + "'"
            ...
            cmd3.CommandText = "update avaliacao_livros set likes = " + nlikes + " where nome_livro = '" + Session("livro") + "' and usuario = '" + e.CommandArgument.ToString() + "'"
            cmd3.ExecuteNonQuery()
            conexao.Close()
            DataBind()
        ElseIf (e.CommandName = "comentar") Then
            Response.Redirect("comentarioslivro.aspx")
