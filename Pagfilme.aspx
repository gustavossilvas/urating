<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Pagfilme.aspx.vb" Inherits="urating.Pagfilme" %>
               ...
               <div class="card-body">
                  <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <center>
                                <asp:Label  ID="nomefilme" runat="server" Text="Label" ForeColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="Bahnschrift" Font-Overline="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="True"></asp:Label>
                                &nbsp;
                            </center>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:friendflixDBConnectionString %>" SelectCommand="select b.foto,a.* from avaliacao_filmes a
inner join usuarios b on a.usuario = b.usuario
where nome_filme = @nome_filme
order by likes desc">
                                <SelectParameters>
                                    <asp:SessionParameter Name="nome_filme" SessionField="filme" />
                                </SelectParameters>
                            </asp:SqlDataSource>
