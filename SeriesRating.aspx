<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="SeriesRating.aspx.vb" Inherits="urating.WebForm4" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <div class="form-group">
                           ...
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Nome da Série"></asp:TextBox>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <label>Nome da Série</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Nome da Série" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
