               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Faça um breve resumo do filme e justifique sua nota" TextMode="MultiLine" Rows="5"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
