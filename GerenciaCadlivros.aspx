<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="GerenciaCadlivros.aspx.vb" Inherits="urating.GerenciaCadlivros" %>
         ...
         <div class="col">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:friendflixDBConnectionString %>" SelectCommand="SELECT * FROM [filalivros]"></asp:SqlDataSource>
                     <div class="col">
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <div class="col-4 mx-auto">
                                                            <div class="btn-group">
                                                                 ...
                                                                 <asp:Button ID="reprovar" class="btn btn-lg btn-danger" runat="server"  Text="Reprovar" Width="211px" OnCommand="reprovarlivro" CommandArgument='<%# Eval("nome_livro") %>' />
                                                      <asp:Button ID="aprovar" class="btn btn-lg btn-success" runat="server"  Text="Aprovar" Width="211px" OnCommand="aprovarlivro" CommandArgument='<%# Eval("nome_livro") %>' />                                                     
