...
Public Class Pagserie
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cmd.CommandText = "select * from series where nome_serie = '" + Session("serie") + "'"
        cmd.ExecuteNonQuery()
        ...
        nomeserie.Text = table.Rows(0)(1).ToString()
        conexao.Close()
    End Sub
    Protected Sub DlistUser_ItemCommand(source As Object, e As DataListCommandEventArgs) Handles DlistUser.ItemCommand
        ...
        If (e.CommandName = "like") Then
            ...
            cmd2.CommandText = "select likes from avaliacao_series where nome_serie = '" + Session("serie") + "' and usuario = '" + e.CommandArgument.ToString() + "'"
            ...
            cmd3.CommandText = "update avaliacao_series set likes = " + nlikes + " where nome_serie = '" + Session("serie") + "' and usuario = '" + e.CommandArgument.ToString() + "'"
            cmd3.ExecuteNonQuery()
            conexao.Close()
            DataBind()
        ElseIf (e.CommandName = "comentar") Then
            Response.Redirect("comentariosserie.aspx")
